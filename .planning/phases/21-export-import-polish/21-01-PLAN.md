...
must_haves:
  truths:
    ...
    - "JSON export includes session_template_name for provenance tracking"
    ...
    - "Session template references round-trip through export/import"
  artifacts:
...
- Position numbering: use the positions from the import data, offset by any existing session_items in the target session.
...
6. Manual: import a v1.2 export (no slides), verify it imports without errors
</verification>
