...
Plans:
- [x] 02-01-PLAN.md -- Install deps, create DB schema (sessions/questions/votes + RLS), TypeScript types, anonymous auth hook
- [x] 02-02-PLAN.md -- React Router v7 setup, Zustand store, session creation flow (Home + AdminSession + ParticipantSession pages)
- [x] 02-03-PLAN.md -- Question CRUD (add/edit/delete/reorder) with QuestionForm and QuestionList components
